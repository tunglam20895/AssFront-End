...
import { AiFillFacebook, AiFillTwitterSquare, AiOutlineGithub, AiFillInstagram } from "react-icons/ai";
                    ...
                    <div className="w-full lg:w-6/12 px-4">
                        ...
                        <div className="mt-6">
                            <button className="bg-white text-blue-400 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2 p-3" type="button">
                                <AiFillTwitterSquare className="flex fab fa-twitter" /></button><button className="bg-white text-blue-600 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2 p-3" type="button">
                                <AiFillFacebook className="flex fab fa-facebook-square" /></button><button className="bg-white text-pink-400 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2 p-3" type="button">
                                <AiFillInstagram className="flex fab fa-dribbble" /></button><button className="bg-white text-gray-900 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2 p-3" type="button">
                                <AiOutlineGithub className="flex fab fa-github" />
                            </button>
                        </div>
                    </div>
                    <div className="w-full lg:w-6/12 px-4">
